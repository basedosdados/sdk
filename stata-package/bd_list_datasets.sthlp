...
{phang}
{bf:bd_list_datasets {hline 2}} Fetch the dataset_id of datasets available at query_project_id. Prints information on screen or returns it as a list. {p_end}

{marker syntax}{...}
{title:Syntax}

{phang}
{cmdab:bd_list_d:atasets} {p_end}
...
{pstd} To use {cmd:bd_list_datasets} you must have Stata version 16+ and the Python {it:`basedosdados`} package installed and configured. If not, 
...
{manhelp bd_download B}, {manhelp bd_table_description B}, {manhelp bd_list_dataset_tables B}, 
